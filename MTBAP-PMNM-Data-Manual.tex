...
\hypersetup{
  pdftitle={MTBAP PMNM Data Manual},
  pdfauthor={Marylou Staman},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{MTBAP PMNM Data Manual}
...
\coverauthorstyle{Marylou Staman\\}};
}
\end{scope}
...
% Title and subtitle
{\fontsize{30}{36.0}\selectfont
\textcolor{black}{\bfseries{\nohyphens{MTBAP PMNM Data Manual}}}\par
}%
}
...
{\authorstyle{\nohyphens{Marylou Staman}{\textsuperscript{1}}}}}

\newcommand{\titlepageaffiliationblock}{
\hangindent=1em
\hangafter=1
{\affiliationstyle{
{1}.~NOAA Fisheries, Pacific Islands Fisheries Science Center,~Protected
Species Division, Marine Turtle Biology and Assessment Program
...
\includegraphics[width=0.5\textwidth,height=\textheight]{images/fig-map.png}
...
\hypertarget{edit-and-add-your-pages}{%
...
\hypertarget{quarto-documentation}{%
...
\hypertarget{step-1.-make-sure-you-have-a-recent-rstudio}{%
...
{\centering \includegraphics{content/Chapter-3_figures_and_tables_files/figure-pdf/fig-pressure-1.pdf}
...
\hypertarget{modify-the-github-action}{%
